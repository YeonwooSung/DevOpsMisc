...
def async_gauge_callback():
    # this callback collects the resident set size of the current process
...
if __name__ == "__main__":
    ...
    # async_counter runs the callback function in every time PeriodicExportingMetricReader is called
    ...
    # Unlike counter, the updown counter can be increased or decreased, and supports negative values as well.
